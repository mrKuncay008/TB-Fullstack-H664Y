...
const ChartDashboard2025 = () => {
      ...
      const config = {
        ...
        options: {
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: 'Grafik Pemasukan dan Pengeluaran Tahun 2025',
            },
          },
        },
      };
  ...
  return (
    <Card className="border shadow-sm p-5 max-w-screen-xl w-full h-[75vh]">
      <div>
        <canvas ref={chartRef}
        className='h-[50vh] pb-14  mb-20'
        ></canvas>
      </div>
    </Card>
  );
...
export default ChartDashboard2025;
